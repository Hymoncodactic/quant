...
| 2026-08-21 | 诚实标注：F3/F4/F11/F14 为「开关开、内容显式配置」型，默认空配置时不产生任何中断压力——runner 在结果元数据写入 `fault_switches_armed_but_empty` 清单，报告层不得声称施加了中断压力（复核发现 6）。历史校准窗口备查：2020-11-24 与 2020-12-14 IB 宕机约 1 小时；2021-01-27~02-02 GME/AMC 只减仓（窗口重叠这些日期的回测应显式配置） |
