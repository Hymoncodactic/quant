...
theming, which belong to a0_report_template.html. Project-wide path constants
...
Constants:
    ...
    OUT_HTML  Path  Delivered report, ROOT/reports/a0_cap1000_20260821.html. The
                    date in the file name is the date of the reported run.
                    Source: literal at the declaration, no external basis.

Inputs:
    research/regime_lab/report/a0_report_template.html   placeholders
                                                         __PLOTLY_JS__ and
                                                         __DATA_JSON__
    research/regime_lab/report/a0_report_data.json       payload
    <installed plotly package>/package_data/plotly.min.js
Outputs:
    reports/a0_cap1000_20260821.html   self-contained, roughly 5 MB, git-ignored
