...
| `alerts.py` | CRITICAL 级交易事件的本机系统通知（macOS osascript），尽力而为永不抛错 | 只写日志无人会在 20:00 UTC 主动去看；歧义冻结、对账失配、成交时序违规必须主动触达 | `trading212/execution/{order_router,reconciler,session_cycle}.py` |
